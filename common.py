...
class Config(object):
    ...
    def _add_basic_config_(self, parser):
        ...
        group.add_argument('--module', type=str, choices=['ae', 'vae', 'gan','imle_gan'], required=True,
                           help="which network module to set")

    def _add_dataset_config_(self, parser):
        """add hyperparameters for dataset configuration"""
        group = parser.add_argument_group('dataset')
        group.add_argument('--dataset_name', type=str, choices=['partnet', 'partnet_scan', '3depn','robust'], required=True,
        ...
        group.add_argument('--batch_size', type=int, default=5, help="batch size")
        ...
        group.add_argument('--n_pts', type=int, default=256,
    ...
    def _add_network_config_(self, parser):
        ...
        self.G_features = (512, 512, 512)
        self.D_features = (256, 512)
        parser.add_argument('--z_dim', type=int, default=128, help="dimension for mode condition vector z")
